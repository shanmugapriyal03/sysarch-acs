...
/* Linux test */
uint32_t p101_entry(uint32_t num_pe);
uint32_t p102_entry(uint32_t num_pe);
uint32_t p103_entry(uint32_t num_pe);
uint32_t p104_entry(uint32_t num_pe);

uint32_t p043_entry(uint32_t num_pe);
uint32_t p044_entry(uint32_t num_pe);
uint32_t p045_entry(uint32_t num_pe);
uint32_t p046_entry(uint32_t num_pe);
