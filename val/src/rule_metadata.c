...
/* TODO: add entries for test wrappers */
};

/* Module name strings mapping to MODULE_NAME_e */
char8_t *module_name_string[MODULE_ID_SENTINEL] = {
    [BASE]         = "BASE",
    [PE]           = "PE",
    [GIC]          = "GIC",
...
char8_t *rule_id_string[RULE_ID_SENTINEL] = {
    /* PE rules */
    [S_L3_01]     = "S_L3_01",
    [B_PE_01]     = "B_PE_01",
    [B_PE_02]     = "B_PE_02",
