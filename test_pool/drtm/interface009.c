...
#define TEST_NUM   (ACS_DRTM_INTERFACE_TEST_NUM_BASE  +  9)
#define TEST_RULE  ""
#define TEST_DESC  "Check SMCCC implemented version       "
...
uint32_t
interface009_entry(uint32_t num_pe)
{
