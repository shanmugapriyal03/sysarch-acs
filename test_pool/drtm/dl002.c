...
#define TEST_NUM   (ACS_DRTM_DL_TEST_NUM_BASE  +  2)
#define TEST_RULE  ""
#define TEST_DESC  "Check DRTM Dynamic Launch Success     "
...
payload(uint32_t num_pe)
{
  ...
  /* Part 2 : DRTM_GET_ERROR Success Case in case of no errors in previous Dynamic Launch */
