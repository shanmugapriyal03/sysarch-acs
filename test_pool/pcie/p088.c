...
#define TEST_NUM   (ACS_PCIE_TEST_NUM_BASE + 88)
...
payload(void)
{
  ...
  table_entries = sizeof(bf_info_table88)/sizeof(bf_info_table88[0]);
  ret = val_pcie_register_bitfields_check((void *)&bf_info_table88, table_entries);
