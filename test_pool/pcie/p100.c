...
#define TEST_NUM   (ACS_PCIE_TEST_NUM_BASE + 100)
#define TEST_RULE  "BJLPB"
#define TEST_DESC  "Check MSI/MSI-X if FRS is supported        "
...
payload(void)
{
  ...
  for (tbl_index = 0; tbl_index < bdf_tbl_ptr->num_entries; tbl_index++)
  {
      ...
      if (dp_type == RP)
      {
         ...
         /* If FRS is supported, MSI or MSI-X must be supported */
