...
#define TEST_NUM   (ACS_PCIE_TEST_NUM_BASE + 55)
...
payload(void)
{
  ...
  table_entries = sizeof(bf_info_table55)/sizeof(bf_info_table55[0]);
  ret = val_pcie_register_bitfields_check((void *)&bf_info_table55, table_entries);
