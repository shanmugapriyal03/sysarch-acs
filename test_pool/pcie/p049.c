...
#define TEST_DESC  "Check config header rule: iEP_EP      "
#define TEST_RULE  "IE_REG_1"
...
payload(void)
{
  ...
  table_entries = sizeof(bf_info_table49)/sizeof(bf_info_table49[0]);
  ret = val_pcie_register_bitfields_check((void *)&bf_info_table49, table_entries);
