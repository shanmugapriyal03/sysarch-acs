...
PE_INFO_TABLE platform_pe_cfg = {
    ...
    .pe_info[0].trbe_interrupt = PLATFORM_OVERRIDE_PE0_TRBE_INTR,
    ...
    .pe_info[1].trbe_interrupt = PLATFORM_OVERRIDE_PE1_TRBE_INTR,
    ...
    .pe_info[2].trbe_interrupt = PLATFORM_OVERRIDE_PE2_TRBE_INTR,
    ...
    .pe_info[3].trbe_interrupt = PLATFORM_OVERRIDE_PE3_TRBE_INTR,
    ...
    .pe_info[4].trbe_interrupt = PLATFORM_OVERRIDE_PE4_TRBE_INTR,
    ...
    .pe_info[5].trbe_interrupt = PLATFORM_OVERRIDE_PE5_TRBE_INTR,
    ...
    .pe_info[6].trbe_interrupt = PLATFORM_OVERRIDE_PE6_TRBE_INTR,
    ...
    .pe_info[8].trbe_interrupt = PLATFORM_OVERRIDE_PE8_TRBE_INTR,
    ...
    .pe_info[9].trbe_interrupt = PLATFORM_OVERRIDE_PE9_TRBE_INTR,
    ...
    .pe_info[10].trbe_interrupt = PLATFORM_OVERRIDE_PE10_TRBE_INTR,
    ...
    .pe_info[11].trbe_interrupt = PLATFORM_OVERRIDE_PE11_TRBE_INTR,
    ...
    .pe_info[12].trbe_interrupt = PLATFORM_OVERRIDE_PE12_TRBE_INTR,
    ...
    .pe_info[13].trbe_interrupt = PLATFORM_OVERRIDE_PE13_TRBE_INTR,
    ...
    .pe_info[14].trbe_interrupt = PLATFORM_OVERRIDE_PE14_TRBE_INTR,
    ...
    .pe_info[15].trbe_interrupt = PLATFORM_OVERRIDE_PE15_TRBE_INTR,
...
PCIE_INFO_TABLE platform_pcie_cfg = {
    ...
    /* Example: Populate multi ECAM info if ECAM count is greater than 1
...
PCIE_ROOT_INFO_TABLE platform_root_pcie_cfg = {
    ...
    .block[1].ep_bar64_value[0]   = PLATFORM_OVERRIDE_PCIE_ECAM1_EP_BAR64,
    .block[1].rp_bar64_value[0]   = PLATFORM_OVERRIDE_PCIE_ECAM1_RP_BAR64,
    .block[1].ep_npbar32_value[0] = PLATFORM_OVERRIDE_PCIE_ECAM1_EP_NPBAR32,
    .block[1].ep_pbar32_value[0]  = PLATFORM_OVERRIDE_PCIE_ECAM1_EP_PBAR32,
    .block[1].rp_bar32_value[0]   = PLATFORM_OVERRIDE_PCIE_ECAM1_RP_BAR32,
    */
};
...
PLATFORM_OVERRIDE_IOVIRT_INFO_TABLE platform_iovirt_cfg = {
    ...
    /* Example: Populate Named component mapping info if map count is non-zero
...
PLATFORM_OVERRIDE_PMCG_NODE_DATA platform_pmcg_node_data = {
    /* Example: Populate PMCG info if number of PMCG nodes are non-zero
...
PLATFORM_OVERRIDE_NAMED_NODE_DATA platform_named_node_data = {
    /* Example: Populate Named components info if number of Named component nodes are non-zero
...
DMA_INFO_TABLE platform_dma_cfg = {
    ...
    /* Example: Populate DMA controller info if number of DMA controllers are non-zero
...
PLATFORM_OVERRIDE_CS_COMP_NODE_DATA platform_cs_comp_node_data = {
    /* Example: Populate Coresight components info if number of CS components are non-zero
...
PLATFORM_OVERRIDE_SRAT_NODE_INFO_TABLE platform_srat_node_type = {
    ...
    /* Example: Populate SRAT GICC affinity info if number of nodes are non-zero
...
PLATFORM_OVERRIDE_PMU_INFO_TABLE platform_pmu_cfg = {
    ...
    /* Example: Populate PMU node info if number of PMU nodes are non-zero */
...
RAS_INFO_TABLE platform_ras_cfg = {
    ...
    /* Example: Populate RAS node info if number of RAS nodes are non-zero */
...
PLATFORM_OVERRIDE_RAS_NODE_DATA_INFO platform_ras_node_data = {
    ...
    /* Example: Populate PE RAS node info if number of PE RAS nodes are non-zero */
    ...
    /* Example: Populate Memory controller RAS node info if number of nodes are non-zero
...
PLATFORM_OVERRIDE_RAS_NODE_INTERFACE_INFO platform_ras_node_interface = {
    ...
    /* Example: Populate RAS Node interface info if RAS node count is non-zero */
...
PLATFORM_OVERRIDE_RAS_NODE_INTERRUPT_INFO platform_ras_node_interrupt = {
    ...
    /* Example : Populate RAS Node Interrupt info if number of such nodes are non-zero */
...
PLATFORM_OVERRIDE_RAS2_INFO_TABLE platform_ras2_cfg = {
    ...
    /* Example : Populate RAS2 node info if number of RAS2 nodes are non-zero
...
PLATFORM_OVERRIDE_MPAM_INFO_TABLE platform_mpam_cfg = {
    ...
    /* Example : Populate MPAM MSC node info if number of such nodes are non-zero
...
PLATFORM_OVERRIDE_PCC_INFO_TABLE platform_pcc_cfg = {
    ...
    /* Example : Populate MPAM PCC type info if number of such nodes are non-zero
