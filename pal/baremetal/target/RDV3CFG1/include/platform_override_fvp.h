...
/* --------------------------------  PE info  -------------------------------- */
#define PLATFORM_OVERRIDE_PE_CNT             8       /* Total processing elements present        */
...
#define PLATFORM_OVERRIDE_GICC_COUNT         0x8     /* Number of CPU interface structures       */
...
#define PLATFORM_OVERRIDE_GICITS_COUNT       0x3     /* Number of ITS blocks                     */
#define PLATFORM_OVERRIDE_GICH_COUNT         0x8     /* Hypervisor interface count               */
...
#define PLATFORM_OVERRIDE_GICR_GICRD_BASE    0x30100000 /* Base of redistributors (GICR)         */
 ...
 *Below 4 macros need not be modified */
...
#define IOVIRT_SMMUV3_COUNT           1           /* Number of SMMUv3 nodes                      */
...
#define IOVIRT_SMMUV3_0_BASE_ADDRESS  0x280000000  /*  SMMUv3 base address                       */
...
#define IOVIRT_RC_MEMORY_PROPERTIES   0x0          /* Root-complex Memory Access properties      */
#define IOVIRT_RC_ATS_ATTRIBUTE       0x1          /* Root-complex ATS attribute                 */

#define IOVIRT_MAX_NUM_MAP            6            /* Used to define size of mapping array       */
#define IOVIRT_RC_NUM_MAP             5            /* Root complex mapping entries               */
#define IOVIRT_SMMUV3_0_NUM_MAP       6            /* SMMU mapping entries                       */
#define IOVIRT_NAMED_COMP0_NUM_MAP    0            /* Name component mapping entries             */
...
#define RC_MAP0_OUTPUT_BASE           0x0          /* The lowest value in the output range       */
#define RC_MAP0_OUTPUT_REF            0xDC         /* Reference to the output IORT Node          */
#define RC_MAP1_INPUT_BASE            0x900
#define RC_MAP1_ID_COUNT              0xFF
#define RC_MAP1_OUTPUT_BASE           0x10900
#define RC_MAP1_OUTPUT_REF            0xDC
#define RC_MAP2_INPUT_BASE            0xA00
#define RC_MAP2_ID_COUNT              0xFF
#define RC_MAP2_OUTPUT_BASE           0x20A00
#define RC_MAP2_OUTPUT_REF            0xDC
#define RC_MAP3_INPUT_BASE            0xB00
#define RC_MAP3_ID_COUNT              0xFF
#define RC_MAP3_OUTPUT_BASE           0x30B00
#define RC_MAP3_OUTPUT_REF            0xDC
#define RC_MAP4_INPUT_BASE            0xC00
#define RC_MAP4_ID_COUNT              0xFF
#define RC_MAP4_OUTPUT_BASE           0x40C00
#define RC_MAP4_OUTPUT_REF            0xDC

#define SMMUV3_0_ID_MAP0_INPUT_BASE   0x0          /* Input base - Refer table 4 in IORT table   */
#define SMMUV3_0_ID_MAP0_ID_COUNT     0x0          /* The number of IDs in the range minus one   */
#define SMMUV3_0_ID_MAP0_OUTPUT_BASE  0x0          /* The lowest value in the output range       */
#define SMMUV3_0_ID_MAP0_OUTPUT_REF   0x18         /* Reference to the output IORT Node          */
#define SMMUV3_0_ID_MAP1_INPUT_BASE   0x0
#define SMMUV3_0_ID_MAP1_ID_COUNT     0x8FF
#define SMMUV3_0_ID_MAP1_OUTPUT_BASE  0x0
#define SMMUV3_0_ID_MAP1_OUTPUT_REF   0x18
#define SMMUV3_0_ID_MAP2_INPUT_BASE   0x10900
#define SMMUV3_0_ID_MAP2_ID_COUNT     0xFF
#define SMMUV3_0_ID_MAP2_OUTPUT_BASE  0x10900
#define SMMUV3_0_ID_MAP2_OUTPUT_REF   0x18
#define SMMUV3_0_ID_MAP3_INPUT_BASE   0x20A00
#define SMMUV3_0_ID_MAP3_ID_COUNT     0xFF
#define SMMUV3_0_ID_MAP3_OUTPUT_BASE  0x20A00
#define SMMUV3_0_ID_MAP3_OUTPUT_REF   0x18
#define SMMUV3_0_ID_MAP4_INPUT_BASE   0x30B00
#define SMMUV3_0_ID_MAP4_ID_COUNT     0xFF
#define SMMUV3_0_ID_MAP4_OUTPUT_BASE  0x30B00
#define SMMUV3_0_ID_MAP4_OUTPUT_REF   0x18
#define SMMUV3_0_ID_MAP5_INPUT_BASE   0x40C00
#define SMMUV3_0_ID_MAP5_ID_COUNT     0xFF
#define SMMUV3_0_ID_MAP5_OUTPUT_BASE  0x40C00
#define SMMUV3_0_ID_MAP5_OUTPUT_REF   0x18
...
#define PLATFORM_OVERRIDE_MEMORY_ENTRY0_PHY_ADDR    0xEF4E0000
#define PLATFORM_OVERRIDE_MEMORY_ENTRY0_VIRT_ADDR   0xEF4E0000
#define PLATFORM_OVERRIDE_MEMORY_ENTRY0_SIZE        0x80000
#define PLATFORM_OVERRIDE_MEMORY_ENTRY0_TYPE        MEMORY_TYPE_DEVICE
#define PLATFORM_OVERRIDE_MEMORY_ENTRY1_PHY_ADDR    0xEF430000
#define PLATFORM_OVERRIDE_MEMORY_ENTRY1_VIRT_ADDR   0xEF430000
#define PLATFORM_OVERRIDE_MEMORY_ENTRY1_SIZE        0x30000
#define PLATFORM_OVERRIDE_MEMORY_ENTRY1_TYPE        MEMORY_TYPE_RESERVED
#define PLATFORM_OVERRIDE_MEMORY_ENTRY2_PHY_ADDR    0xED5DF000
#define PLATFORM_OVERRIDE_MEMORY_ENTRY2_VIRT_ADDR   0xED5DF000
#define PLATFORM_OVERRIDE_MEMORY_ENTRY2_SIZE        0x78000
...
#define PLATFORM_OVERRIDE_MEMORY_ENTRY3_SIZE        0x10000
...
#define PLATFORM_OVERRIDE_CACHE_CNT            25       /* Total cache descriptor entries        */

#define PLATFORM_CACHE0_FLAGS                  0xFF     /* PPTT table - Cache structure flags    */
#define PLATFORM_CACHE0_OFFSET                 0x88     /* Cache offset in the PPTT table        */
...
#define PLATFORM_CACHE1_OFFSET                 0xC0
#define PLATFORM_CACHE1_NEXT_LEVEL_INDEX       2
...
#define PLATFORM_CACHE2_OFFSET                 0x3C
#define PLATFORM_CACHE2_NEXT_LEVEL_INDEX       -1
#define PLATFORM_CACHE2_SIZE                   0x800000
#define PLATFORM_CACHE2_CACHE_ID               0xFFFF4
#define PLATFORM_CACHE2_IS_PRIVATE             0x0
#define PLATFORM_CACHE2_TYPE                   2

#define PLATFORM_CACHE3_FLAGS                  0xFF
#define PLATFORM_CACHE3_OFFSET                 0xA4
#define PLATFORM_CACHE3_NEXT_LEVEL_INDEX       1
#define PLATFORM_CACHE3_SIZE                   0x10000
#define PLATFORM_CACHE3_CACHE_ID               0x2
#define PLATFORM_CACHE3_IS_PRIVATE             0x1
#define PLATFORM_CACHE3_TYPE                   1

#define PLATFORM_CACHE4_FLAGS                  0xFF
#define PLATFORM_CACHE4_OFFSET                 0x10C
#define PLATFORM_CACHE4_NEXT_LEVEL_INDEX       5
#define PLATFORM_CACHE4_SIZE                   0x10000
#define PLATFORM_CACHE4_CACHE_ID               0x1001
#define PLATFORM_CACHE4_IS_PRIVATE             0x1
#define PLATFORM_CACHE4_TYPE                   0

#define PLATFORM_CACHE5_FLAGS                  0xFF
#define PLATFORM_CACHE5_OFFSET                 0x144
#define PLATFORM_CACHE5_NEXT_LEVEL_INDEX       2
#define PLATFORM_CACHE5_SIZE                   0x100000
#define PLATFORM_CACHE5_CACHE_ID               0x1003
#define PLATFORM_CACHE5_IS_PRIVATE             0x1
#define PLATFORM_CACHE5_TYPE                   2

#define PLATFORM_CACHE6_FLAGS                  0xFF
#define PLATFORM_CACHE6_OFFSET                 0x128
#define PLATFORM_CACHE6_NEXT_LEVEL_INDEX       5
#define PLATFORM_CACHE6_SIZE                   0x10000
#define PLATFORM_CACHE6_CACHE_ID               0x1002
#define PLATFORM_CACHE6_IS_PRIVATE             0x1
#define PLATFORM_CACHE6_TYPE                   1

#define PLATFORM_CACHE7_FLAGS                  0xFF
#define PLATFORM_CACHE7_OFFSET                 0x190
#define PLATFORM_CACHE7_NEXT_LEVEL_INDEX       8
#define PLATFORM_CACHE7_SIZE                   0x10000
#define PLATFORM_CACHE7_CACHE_ID               0x2001
#define PLATFORM_CACHE7_IS_PRIVATE             0x1
#define PLATFORM_CACHE7_TYPE                   0

#define PLATFORM_CACHE8_FLAGS                  0xFF
#define PLATFORM_CACHE8_OFFSET                 0x1C8
#define PLATFORM_CACHE8_NEXT_LEVEL_INDEX       2
#define PLATFORM_CACHE8_SIZE                   0x100000
#define PLATFORM_CACHE8_CACHE_ID               0x2003
#define PLATFORM_CACHE8_IS_PRIVATE             0x1
#define PLATFORM_CACHE8_TYPE                   2

#define PLATFORM_CACHE9_FLAGS                  0xFF
#define PLATFORM_CACHE9_OFFSET                 0x1AC
#define PLATFORM_CACHE9_NEXT_LEVEL_INDEX       8
#define PLATFORM_CACHE9_SIZE                   0x10000
#define PLATFORM_CACHE9_CACHE_ID               0x2002
#define PLATFORM_CACHE9_IS_PRIVATE             0x1
#define PLATFORM_CACHE9_TYPE                   1

#define PLATFORM_CACHE10_FLAGS                 0xFF
#define PLATFORM_CACHE10_OFFSET                0x214
#define PLATFORM_CACHE10_NEXT_LEVEL_INDEX      11
#define PLATFORM_CACHE10_SIZE                  0x10000
#define PLATFORM_CACHE10_CACHE_ID              0x3001
#define PLATFORM_CACHE10_IS_PRIVATE            0x1
#define PLATFORM_CACHE10_TYPE                  0

#define PLATFORM_CACHE11_FLAGS                 0xFF
#define PLATFORM_CACHE11_OFFSET                0x24C
#define PLATFORM_CACHE11_NEXT_LEVEL_INDEX      2
#define PLATFORM_CACHE11_SIZE                  0x100000
#define PLATFORM_CACHE11_CACHE_ID              0x3003
#define PLATFORM_CACHE11_IS_PRIVATE            0x1
#define PLATFORM_CACHE11_TYPE                  2

#define PLATFORM_CACHE12_FLAGS                 0xFF
#define PLATFORM_CACHE12_OFFSET                0x230
#define PLATFORM_CACHE12_NEXT_LEVEL_INDEX      11
#define PLATFORM_CACHE12_SIZE                  0x10000
#define PLATFORM_CACHE12_CACHE_ID              0x3002
#define PLATFORM_CACHE12_IS_PRIVATE            0x1
#define PLATFORM_CACHE12_TYPE                  1

#define PLATFORM_CACHE13_FLAGS                 0xFF
#define PLATFORM_CACHE13_OFFSET                0x298
#define PLATFORM_CACHE13_NEXT_LEVEL_INDEX      14
#define PLATFORM_CACHE13_SIZE                  0x10000
#define PLATFORM_CACHE13_CACHE_ID              0x4001
#define PLATFORM_CACHE13_IS_PRIVATE            0x1
#define PLATFORM_CACHE13_TYPE                  0

#define PLATFORM_CACHE14_FLAGS                 0xFF
#define PLATFORM_CACHE14_OFFSET                0x2D0
#define PLATFORM_CACHE14_NEXT_LEVEL_INDEX      2
#define PLATFORM_CACHE14_SIZE                  0x100000
#define PLATFORM_CACHE14_CACHE_ID              0x4003
#define PLATFORM_CACHE14_IS_PRIVATE            0x1
#define PLATFORM_CACHE14_TYPE                  2

#define PLATFORM_CACHE15_FLAGS                 0xFF
#define PLATFORM_CACHE15_OFFSET                0x2B4
#define PLATFORM_CACHE15_NEXT_LEVEL_INDEX      14
#define PLATFORM_CACHE15_SIZE                  0x10000
#define PLATFORM_CACHE15_CACHE_ID              0x4002
#define PLATFORM_CACHE15_IS_PRIVATE            0x1
#define PLATFORM_CACHE15_TYPE                  1

#define PLATFORM_CACHE16_FLAGS                 0xFF
#define PLATFORM_CACHE16_OFFSET                0x31C
#define PLATFORM_CACHE16_NEXT_LEVEL_INDEX      17
#define PLATFORM_CACHE16_SIZE                  0x10000
#define PLATFORM_CACHE16_CACHE_ID              0x5001
#define PLATFORM_CACHE16_IS_PRIVATE            0x1
#define PLATFORM_CACHE16_TYPE                  0

#define PLATFORM_CACHE17_FLAGS                 0xFF
#define PLATFORM_CACHE17_OFFSET                0x354
#define PLATFORM_CACHE17_NEXT_LEVEL_INDEX      2
#define PLATFORM_CACHE17_SIZE                  0x100000
#define PLATFORM_CACHE17_CACHE_ID              0x5003
#define PLATFORM_CACHE17_IS_PRIVATE            0x1
#define PLATFORM_CACHE17_TYPE                  2

#define PLATFORM_CACHE18_FLAGS                 0xFF
#define PLATFORM_CACHE18_OFFSET                0x338
#define PLATFORM_CACHE18_NEXT_LEVEL_INDEX      17
#define PLATFORM_CACHE18_SIZE                  0x10000
#define PLATFORM_CACHE18_CACHE_ID              0x5002
#define PLATFORM_CACHE18_IS_PRIVATE            0x1
#define PLATFORM_CACHE18_TYPE                  1

#define PLATFORM_CACHE19_FLAGS                 0xFF
#define PLATFORM_CACHE19_OFFSET                0x3A0
#define PLATFORM_CACHE19_NEXT_LEVEL_INDEX      20
#define PLATFORM_CACHE19_SIZE                  0x10000
#define PLATFORM_CACHE19_CACHE_ID              0x6001
#define PLATFORM_CACHE19_IS_PRIVATE            0x1
#define PLATFORM_CACHE19_TYPE                  0

#define PLATFORM_CACHE20_FLAGS                 0xFF
#define PLATFORM_CACHE20_OFFSET                0x3D8
#define PLATFORM_CACHE20_NEXT_LEVEL_INDEX      2
#define PLATFORM_CACHE20_SIZE                  0x100000
#define PLATFORM_CACHE20_CACHE_ID              0x6003
#define PLATFORM_CACHE20_IS_PRIVATE            0x1
#define PLATFORM_CACHE20_TYPE                  2

#define PLATFORM_CACHE21_FLAGS                 0xFF
#define PLATFORM_CACHE21_OFFSET                0x3BC
#define PLATFORM_CACHE21_NEXT_LEVEL_INDEX      20
#define PLATFORM_CACHE21_SIZE                  0x10000
#define PLATFORM_CACHE21_CACHE_ID              0x6002
#define PLATFORM_CACHE21_IS_PRIVATE            0x1
#define PLATFORM_CACHE21_TYPE                  1

#define PLATFORM_CACHE22_FLAGS                 0xFF
#define PLATFORM_CACHE22_OFFSET                0x424
#define PLATFORM_CACHE22_NEXT_LEVEL_INDEX      23
#define PLATFORM_CACHE22_SIZE                  0x10000
#define PLATFORM_CACHE22_CACHE_ID              0x7001
#define PLATFORM_CACHE22_IS_PRIVATE            0x1
#define PLATFORM_CACHE22_TYPE                  0

#define PLATFORM_CACHE23_FLAGS                 0xFF
#define PLATFORM_CACHE23_OFFSET                0x45C
#define PLATFORM_CACHE23_NEXT_LEVEL_INDEX      2
#define PLATFORM_CACHE23_SIZE                  0x100000
#define PLATFORM_CACHE23_CACHE_ID              0x7003
#define PLATFORM_CACHE23_IS_PRIVATE            0x1
#define PLATFORM_CACHE23_TYPE                  2

#define PLATFORM_CACHE24_FLAGS                 0xFF
#define PLATFORM_CACHE24_OFFSET                0x440
#define PLATFORM_CACHE24_NEXT_LEVEL_INDEX      23
#define PLATFORM_CACHE24_SIZE                  0x10000
#define PLATFORM_CACHE24_CACHE_ID              0x7002
#define PLATFORM_CACHE24_IS_PRIVATE            0x1
#define PLATFORM_CACHE24_TYPE                  1
...
/* SRAT config */
#define PLATFORM_OVERRIDE_NUM_SRAT_ENTRIES  0            /* Number of SRAT entries               */
#define PLATFORM_OVERRIDE_MEM_AFF_CNT       0            /* Number of Memory affinity entries    */
#define PLATFORM_OVERRIDE_GICC_AFF_CNT      0            /* Number of GICC affinity entries      */

/* Placeholder: SRAT MEM, GICC info
...
#define PLATFORM_OVERRIDE_NUM_OF_HMAT_PROX_DOMAIN 0      /* Number of target proximity domains   */
#define PLATFORM_OVERRIDE_HMAT_MEM_ENTRIES    0x0
#define HMAT_NODE_MEM_SLLBIC                  0x1       // Helper - System Locality Latn and BW Info

/* Placeholder: HMAT info
...
#define PLATFORM_OVERRIDE_PMU_NODE_CNT        0x0           /* PMU Node count in the system      */

/* Placeholder: PMU info
...
#define PLATFORM_OVERRIDE_NUM_RAS_NODES       0x6           // Number of RAS nodes in the system
...
/*MPAM Config*/
#define MPAM_MAX_MSC_NODE                     0x8    /* Used by ACS to define MSC array len      */
#define MPAM_MAX_RSRC_NODE                    0x1    /* Max resource nodes per MSC - Used by ACS */
#define PLATFORM_MPAM_MSC_COUNT               0x8    /* MSC nodes present in the system          */
...
#define PLATFORM_MPAM_MSC1_INTR_TYPE          0x0
#define PLATFORM_MPAM_MSC1_ID                 0x2
#define PLATFORM_MPAM_MSC1_BASE_ADDR          0x102A01000
#define PLATFORM_MPAM_MSC1_ADDR_LEN           0x1008
#define PLATFORM_MPAM_MSC1_MAX_NRDY           0
#define PLATFORM_MPAM_MSC1_RSRC_COUNT         0x1
#define PLATFORM_MPAM_MSC1_RSRC0_RIS_INDEX    0x0
#define PLATFORM_MPAM_MSC1_RSRC0_LOCATOR_TYPE 0x0
#define PLATFORM_MPAM_MSC1_RSRC0_DESCRIPTOR1  0xFFFF4
#define PLATFORM_MPAM_MSC1_RSRC0_DESCRIPTOR2  0x0

#define PLATFORM_MPAM_MSC2_INTR_TYPE          0x0
#define PLATFORM_MPAM_MSC2_ID                 0x3
#define PLATFORM_MPAM_MSC2_BASE_ADDR          0x102641000
#define PLATFORM_MPAM_MSC2_ADDR_LEN           0x1008
#define PLATFORM_MPAM_MSC2_MAX_NRDY           0
#define PLATFORM_MPAM_MSC2_RSRC_COUNT         0x1
#define PLATFORM_MPAM_MSC2_RSRC0_RIS_INDEX    0x0
#define PLATFORM_MPAM_MSC2_RSRC0_LOCATOR_TYPE 0x0
#define PLATFORM_MPAM_MSC2_RSRC0_DESCRIPTOR1  0xFFFF4
#define PLATFORM_MPAM_MSC2_RSRC0_DESCRIPTOR2  0x0

#define PLATFORM_MPAM_MSC3_INTR_TYPE          0x0
#define PLATFORM_MPAM_MSC3_ID                 0x4
#define PLATFORM_MPAM_MSC3_BASE_ADDR          0x102601000
#define PLATFORM_MPAM_MSC3_ADDR_LEN           0x1008
#define PLATFORM_MPAM_MSC3_MAX_NRDY           0
#define PLATFORM_MPAM_MSC3_RSRC_COUNT         0x1
#define PLATFORM_MPAM_MSC3_RSRC0_RIS_INDEX    0x0
#define PLATFORM_MPAM_MSC3_RSRC0_LOCATOR_TYPE 0x0
#define PLATFORM_MPAM_MSC3_RSRC0_DESCRIPTOR1  0x0
#define PLATFORM_MPAM_MSC3_RSRC0_DESCRIPTOR2  0x0

#define PLATFORM_MPAM_MSC4_INTR_TYPE          0x0
#define PLATFORM_MPAM_MSC4_ID                 0x5
#define PLATFORM_MPAM_MSC4_BASE_ADDR          0x101A41000
#define PLATFORM_MPAM_MSC4_ADDR_LEN           0x1008
#define PLATFORM_MPAM_MSC4_MAX_NRDY           0
#define PLATFORM_MPAM_MSC4_RSRC_COUNT         0x1
#define PLATFORM_MPAM_MSC4_RSRC0_RIS_INDEX    0x0
#define PLATFORM_MPAM_MSC4_RSRC0_LOCATOR_TYPE 0x0
#define PLATFORM_MPAM_MSC4_RSRC0_DESCRIPTOR1  0xFFFF4
#define PLATFORM_MPAM_MSC4_RSRC0_DESCRIPTOR2  0x0

#define PLATFORM_MPAM_MSC5_INTR_TYPE          0x0
#define PLATFORM_MPAM_MSC5_ID                 0x6
#define PLATFORM_MPAM_MSC5_BASE_ADDR          0x101A01000
#define PLATFORM_MPAM_MSC5_ADDR_LEN           0x1008
#define PLATFORM_MPAM_MSC5_MAX_NRDY           0
#define PLATFORM_MPAM_MSC5_RSRC_COUNT         0x1
#define PLATFORM_MPAM_MSC5_RSRC0_RIS_INDEX    0x0
#define PLATFORM_MPAM_MSC5_RSRC0_LOCATOR_TYPE 0x0
#define PLATFORM_MPAM_MSC5_RSRC0_DESCRIPTOR1  0xFFFF4
#define PLATFORM_MPAM_MSC5_RSRC0_DESCRIPTOR2  0x0

#define PLATFORM_MPAM_MSC6_INTR_TYPE          0x0
#define PLATFORM_MPAM_MSC6_ID                 0x7
#define PLATFORM_MPAM_MSC6_BASE_ADDR          0x101641000
#define PLATFORM_MPAM_MSC6_ADDR_LEN           0x1008
#define PLATFORM_MPAM_MSC6_MAX_NRDY           0
#define PLATFORM_MPAM_MSC6_RSRC_COUNT         0x1
#define PLATFORM_MPAM_MSC6_RSRC0_RIS_INDEX    0x0
#define PLATFORM_MPAM_MSC6_RSRC0_LOCATOR_TYPE 0x0
#define PLATFORM_MPAM_MSC6_RSRC0_DESCRIPTOR1  0xFFFF4
#define PLATFORM_MPAM_MSC6_RSRC0_DESCRIPTOR2  0x0

#define PLATFORM_MPAM_MSC7_INTR_TYPE          0x0
#define PLATFORM_MPAM_MSC7_ID                 0x8
#define PLATFORM_MPAM_MSC7_BASE_ADDR          0x101601000
#define PLATFORM_MPAM_MSC7_ADDR_LEN           0x1008
#define PLATFORM_MPAM_MSC7_MAX_NRDY           0
#define PLATFORM_MPAM_MSC7_RSRC_COUNT         0x1
#define PLATFORM_MPAM_MSC7_RSRC0_RIS_INDEX    0x0
#define PLATFORM_MPAM_MSC7_RSRC0_LOCATOR_TYPE 0x0
#define PLATFORM_MPAM_MSC7_RSRC0_DESCRIPTOR1  0xFFFF4
#define PLATFORM_MPAM_MSC7_RSRC0_DESCRIPTOR2  0x0
