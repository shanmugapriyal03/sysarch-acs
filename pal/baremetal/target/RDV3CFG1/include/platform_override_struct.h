...
typedef struct {
  ...
  uint32_t gicc_type;
  uint32_t gicd_type;
  uint32_t gicc_rd_length;
  uint32_t gicr_rd_length;
  uint32_t gicits_type;
  uint64_t gicc_base[PLATFORM_OVERRIDE_GICC_COUNT];
  uint64_t gicd_base[PLATFORM_OVERRIDE_GICD_COUNT];
  uint64_t gicc_rd_base[PLATFORM_OVERRIDE_GICC_GICRD_COUNT];
  uint64_t gicr_rd_base[PLATFORM_OVERRIDE_GICR_GICRD_COUNT];
...
typedef struct {
  ...
  uint8_t  frame_num[PLATFORM_OVERRIDE_TIMER_COUNT];
