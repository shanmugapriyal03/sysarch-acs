...
PLATFORM_OVERRIDE_IOVIRT_INFO_TABLE platform_iovirt_cfg = {
    ...
    .map[1].input_base[1] = SMMUV3_0_ID_MAP1_INPUT_BASE,
    .map[1].id_count[1]   = SMMUV3_0_ID_MAP1_ID_COUNT,
    .map[1].output_base[1] = SMMUV3_0_ID_MAP1_OUTPUT_BASE,
    .map[1].output_ref[1] = SMMUV3_0_ID_MAP1_OUTPUT_REF,
    .map[1].input_base[2] = SMMUV3_0_ID_MAP2_INPUT_BASE,
    .map[1].id_count[2]   = SMMUV3_0_ID_MAP2_ID_COUNT,
    .map[1].output_base[2] = SMMUV3_0_ID_MAP2_OUTPUT_BASE,
    .map[1].output_ref[2] = SMMUV3_0_ID_MAP2_OUTPUT_REF,
    .map[1].input_base[3] = SMMUV3_0_ID_MAP3_INPUT_BASE,
    .map[1].id_count[3]   = SMMUV3_0_ID_MAP3_ID_COUNT,
    .map[1].output_base[3] = SMMUV3_0_ID_MAP3_OUTPUT_BASE,
    .map[1].output_ref[3] = SMMUV3_0_ID_MAP3_OUTPUT_REF,
    .map[1].input_base[4] = SMMUV3_0_ID_MAP4_INPUT_BASE,
    .map[1].id_count[4]   = SMMUV3_0_ID_MAP4_ID_COUNT,
    .map[1].output_base[4] = SMMUV3_0_ID_MAP4_OUTPUT_BASE,
    .map[1].output_ref[4] = SMMUV3_0_ID_MAP4_OUTPUT_REF,
    .map[1].input_base[5] = SMMUV3_0_ID_MAP5_INPUT_BASE,
    .map[1].id_count[5]   = SMMUV3_0_ID_MAP5_ID_COUNT,
    .map[1].output_base[5] = SMMUV3_0_ID_MAP5_OUTPUT_BASE,
    .map[1].output_ref[5] = SMMUV3_0_ID_MAP5_OUTPUT_REF,
    ...
    .map[2].input_base[1] = RC_MAP1_INPUT_BASE,
    .map[2].id_count[1]   = RC_MAP1_ID_COUNT,
    .map[2].output_base[1] = RC_MAP1_OUTPUT_BASE,
    .map[2].output_ref[1] = RC_MAP1_OUTPUT_REF,
    .map[2].input_base[2] = RC_MAP2_INPUT_BASE,
    .map[2].id_count[2]   = RC_MAP2_ID_COUNT,
    .map[2].output_base[2] = RC_MAP2_OUTPUT_BASE,
    .map[2].output_ref[2] = RC_MAP2_OUTPUT_REF,
    .map[2].input_base[3] = RC_MAP3_INPUT_BASE,
    .map[2].id_count[3]   = RC_MAP3_ID_COUNT,
    .map[2].output_base[3] = RC_MAP3_OUTPUT_BASE,
    .map[2].output_ref[3] = RC_MAP3_OUTPUT_REF,
    .map[2].input_base[4] = RC_MAP4_INPUT_BASE,
    .map[2].id_count[4]   = RC_MAP4_ID_COUNT,
    .map[2].output_base[4] = RC_MAP4_OUTPUT_BASE,
    .map[2].output_ref[4] = RC_MAP4_OUTPUT_REF,
