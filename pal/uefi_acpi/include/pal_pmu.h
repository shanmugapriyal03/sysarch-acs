...
#ifndef __PAL_SBSA_PMU_H__
#define __PAL_SBSA_PMU_H__

/* Not defined APMT related structures and defines in EDK2,
 * Remove this header once EDK2 supports APMT */

#define ARM_PERFORMANCE_MONITORING_TABLE_SIGNATURE SIGNATURE_32('A', 'P', 'M', 'T')
...
typedef struct {
    ...
    UINT8  type;
    UINT32 identifier;
    UINT64 primary_instance;
    UINT32 secondary_instance;
    UINT64 base_addr0;
    UINT64 base_addr1;
    UINT32 interrupt;
    UINT32 reserved;
